...
reader.readAsDataURL(event.target.files[0]);
    ...
    return(
        ...
        <StyledProfileHeader>
         <StyledForm>
          <StyledLabel htmlFor="userUpload">Select your Profilepicture</StyledLabel>
          <StyledInput onChange={handleFileChange} type="file" id="userUpload" name="avatar"  accept="image/png, image/jpeg"></StyledInput>
